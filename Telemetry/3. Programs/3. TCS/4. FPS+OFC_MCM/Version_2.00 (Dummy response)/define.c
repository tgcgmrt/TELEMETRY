...
#define MY_IP_ADDR     "10.29.135.53"
#define MY_GATEWAY     "10.29.135.1"
#define MY_NET_MASK    "255.255.255.0"
#define FPS_SERVER_ADDR    "10.29.135.19"  // Server for lab testing
#define FPS_SERVER_PORT    "3004"           // For 192.168.8.143
#define OFC_SERVER_ADDR    "10.29.135.19"
