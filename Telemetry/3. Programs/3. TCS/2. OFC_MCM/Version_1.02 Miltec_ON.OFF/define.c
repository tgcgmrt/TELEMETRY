...
//**************************** Defination part for OFCSNT System *************************//
...
int SS, FDB, FDV, MON, Temp_SS, Temp_FDB, Temp_FDV,Temp_MON;
...
#web MON	select("Choose ON/OFF" = 0, "On", "Off")  //changed on 14oct2019--miltec on/off
...
char dmask[10];
char port_val1, port_val2; //110ct2019
